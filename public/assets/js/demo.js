...
// Fungsi untuk memastikan warna ikon sidebar tetap hitam
function setIconColorToBlack() {
	document.querySelectorAll('.gg-menu-right, .gg-menu-left, .gg-more-vertical-alt').forEach(function(icon) {
  ...
  // Panggil fungsi juga saat jendela diubah ukurannya untuk menjaga warna hitam pada ikon
