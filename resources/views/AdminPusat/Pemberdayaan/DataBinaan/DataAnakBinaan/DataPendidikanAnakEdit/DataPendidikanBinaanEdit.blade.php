        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ $anak->anakPendidikan ? route('edit.prosess.PendidikanAnak', $anak->anakPendidikan->id_anak_pend) : '#' }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenjang" id="jenjang_pendidikan" class="form-control" required>
                                    ...
                                    <option value="belum_sd" {{ optional($anak->anakPendidikan)->jenjang == 'belum_sd' ? 'selected' : '' }}>Belum SD</option>
                                    <option value="sd" {{ optional($anak->anakPendidikan)->jenjang == 'sd' ? 'selected' : '' }}>SD</option>
                                    <option value="smp" {{ optional($anak->anakPendidikan)->jenjang == 'smp' ? 'selected' : '' }}>SMP</option>
                                    <option value="sma" {{ optional($anak->anakPendidikan)->jenjang == 'sma' ? 'selected' : '' }}>SMA</option>
                                    <option value="perguruan_tinggi" {{ optional($anak->anakPendidikan)->jenjang == 'perguruan_tinggi' ? 'selected' : '' }}>Perguruan Tinggi</option>
                                </select>
                            </div>
