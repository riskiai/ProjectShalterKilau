                    ...
                    <div class="card">
                        <div class="card-header info-section">
                            ...
                            <div class="status-badge">
                                ...
                                <span class="btn btn-warning text-white">
                                    @if ($anak->status_validasi === \App\Models\Anak::STATUS_NON_AKTIF)
                                        <i class="fa fa-times" style="margin-right: 10px;"></i> Non Aktif
                                    @endif
                                </span>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    @include('AdminPusat.Pemberdayaan.DataBinaan.DataNonBinaan.navbarAnakNonBinaan')

                                    <!-- Konten dinamis berdasarkan tab yang dipilih -->
                                    <div class="row">
                                        @if (request()->get('tab') == 'anak-pendidikan')
                                            @include('AdminPusat.Pemberdayaan.DataBinaan.DataNonBinaan.datapendidikannonbinaan')
                                        @elseif(request()->get('tab') == 'anak-keluarga')
                                            @include('AdminPusat.Pemberdayaan.DataBinaan.DataNonBinaan.datakeluarganonbinaan')
                                        @else
                                            <h4>Data Anak</h4>
                                    ...
                                    <!-- Tidak ada tombol edit di Data Non Anak Binaan -->
                                    <div class="action-buttons">
                                        <a href="{{ route('NonAnakBinaan') }}" class="btn btn-primary btn-kembali">
