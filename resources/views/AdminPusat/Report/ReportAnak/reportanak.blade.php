            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="filter-section">
                        <form action="" method="GET">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="bulan">Jenis Kegiatan</label>
                                        <select name="bulan" id="bulan" class="form-control">
                                            <option value="" disabled selected>--PILIH--</option>
                                            <option value="Januari">Agama</option>
                                            <option value="Februari">Bimbel</option>
                                            <option value="Maret">Tahfidz</option>
                                        </select>
                                    </div>
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" id="percentageTab" href="#"
                                style="color:#5a5a5a; font-weight:400;">Presentase</a>
                        </li>
                    </ul>
                                ...
                                @foreach ($data_anak as $anak)
                                    <tr>
                                        ...
                                        <td><button class="btn btn-view"
                                                onclick="showChartModal('{{ $anak->full_name }}')">Lihat</button></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="chartModalLabel">Grafik Absensi Anak</h5>
...
@section('scripts')
    ...
    <script>
        ...
        function showChartModal(anakName) {
            $('#chartModalLabel').text('Grafik Absensi Anak: ' + anakName);
        ...
        function exportChart() {
            ...
            html2canvas(chartContainer, {
                scale: 2, // meningkatkan kualitas hasil tangkapan
                allowTaint: true, // mengizinkan kanvas untuk diambil meskipun ada data dari domain lain
                useCORS: true // mengatasi batasan sumber daya lintas-domain
            }).then(canvas => {
                ...
                pdf.save('Grafik_Absensi_Anak.pdf');
            });
        }
    </script>
@endsection
