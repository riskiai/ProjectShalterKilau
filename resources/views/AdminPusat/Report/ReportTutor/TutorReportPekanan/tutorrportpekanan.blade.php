    ...
    <div class="page-inner">
        <div class="card">
            <div class="card-header">
                Laporan Kehadiran Tutor: Bimbingan Pekanan
            </div>
            <div class="card-body">
                <!-- Filter Section -->
                ...
                <!-- Tab Section -->
                @include('AdminPusat.Report.ReportTutor.TutorReportPekanan.navbarreportpekanan')

                <!-- Content Section -->
                @if (request()->get('tab') == 'quantitas')
                    @include('AdminPusat.Report.ReportTutor.TutorReportPekanan.quantitastutor')
                @elseif (request()->get('tab') == 'bulanan')
                    @include('AdminPusat.Report.ReportTutor.TutorReportPekanan.bulanantutor')
                @else
