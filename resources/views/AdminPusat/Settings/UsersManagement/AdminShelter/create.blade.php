            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah Admin Shelter</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin_shelter.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_wilbin" id="wilbin" class="form-control" required>
                                    ...
                                    @foreach($wilbin as $wil)
                                        <option value="{{ $wil->id_wilbin }}">{{ $wil->nama_wilbin }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Alamat</label>
                                <textarea name="alamat_adm" class="form-control" rows="3" required></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('admin_shelter') }}" class="btn btn-secondary mt-3">Batal</a>
                            </div>
                        </form>
                    </div>
                </div>
